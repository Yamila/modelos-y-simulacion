...
def cargar_inivitados(sala):
	...
	alberto.ideal = ideales(invitados, 0,0,5,7,4,2,3,6,2)
	berta.ideal = ideales(invitados, 3,0,0,1,2.5,0.5,1.5,3.5,1)
	demetrio.ideal = ideales(invitados, 3.5,0.5,0,0,1.5,1,3.5,2.5,0.5)
	hilario.ideal = ideales(invitados,2,2.5,4,0,0,2,1,2.5,1.5)
	monica.ideal = ideales(invitados,1,2,1,0,0,0.5,3,4,7)
	nemesio.ideal = ideales(invitados,2.5,1,2,3,4,0,0,3,3)
	penelope.ideal = ideales(invitados,1,5,1.5,4.5,4,3,0,0,0)
	violeta.ideal = ideales(invitados,0,4,4,5,1,5,8,0,4)
	return invitados
